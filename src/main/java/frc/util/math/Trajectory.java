...
public class Trajectory {
    ...
    private double angle = Constants.ANGLE;
    ...
    private double calculateVelocity(double distance, double height, double angle){

        //calculate for theoretical distance with limelight distance
        double theoDistanceC1 = Math.pow(distance,2)*0.075;
        double theoDistanceC2 = 0.882*distance + theoDistanceC1 ;
        double theoDistance = theoDistanceC2 + 0.664;
